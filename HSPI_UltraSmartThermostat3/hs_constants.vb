Module hs_constants
  ...
  Public Const USER_LOCAL As Integer = 4    ' this user is used when loging in on a local subnet
  ...
  Public Const MISC_NO_LOG As Integer = 8                 ' no loging to event log for this device
  ...
  Enum dvMISC As UInteger
    NO_LOG = 8                      ' No loging to the log for this device
